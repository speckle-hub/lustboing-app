...
const PLATFORMS = {
  ...
  xhamster: { name: 'xHamster', color: '#f9a825', icon: '🟡', embedBase: (id) => `https://xhamster.com/xembed.php?video=${id}`,       sourceBase: (id) => `https://xhamster.com/videos/x${id}` },
...
function openPlayer(video) {
  ...
  sourceLink.href = platform.sourceBase(video.videoId);
